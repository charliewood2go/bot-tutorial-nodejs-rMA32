...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      botRegex = /^\/cool guy/;  botRegexDL = /^\/DEP/i;botRegexSalt = /^\/boot/;botRegexRules = /^\/rules/
      ...
      botRegexProp = /^\/rankings/;botRegexKys = /^\/home/; botRegexSlam = /^\/schedule/; botRegexBrye = /^\/brye/;
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("https://media1.tenor.com/images/92baf2592af2b62e69a62a6af0d67578/tenor.gif?itemid=7799570");
    this.res.end();
  }
